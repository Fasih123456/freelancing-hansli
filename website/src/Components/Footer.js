        ...
        <div class="container1">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p className="font para" style={{ textAlign: "left" }}>
              ...
              much simpler. It offers a well-designed interface which shows the schedule of all your
              favorite TV shows and movies all at one place. Furthermore, TV2nite comes with a range
              of tools and features that you haven’t seen anywhere else. So, buckle up because, you
              are in for a wild ride with TV2nite. Never miss an episode of your show ever again and
              enjoy TV the way you like it.
            </p>
          </div>
